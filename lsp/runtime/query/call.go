...
// (call ; [30, 4] - [30, 50]
//         function: (identifier) ; [30, 4] - [30, 27]
//         arguments: (argument_list ; [30, 27] - [30, 50]
//           (keyword_argument ; [30, 28] - [30, 39]
//             name: (identifier) ; [30, 28] - [30, 32]
//             value: (string ; [30, 33] - [30, 39]
//               (string_start) ; [30, 33] - [30, 34]
//               (string_content) ; [30, 34] - [30, 38]
//               (string_end))) ; [30, 38] - [30, 39]
//           (keyword_argument ; [30, 41] - [30, 48]
//             name: (identifier) ; [30, 41] - [30, 45]
//             value: (integer))))

// TODO: bsena; Extract arguments and literal values
const callQuery = `
...
func QueryCalls(tree *tree_sitter.Tree, text []byte, source string) ([]*symbol.Symbol, error) {
	...
	for match := matches.Next(); match != nil; match = matches.Next() {
		...
		for _, capture := range match.Captures {
			...
			case "call.arg":
				newParam := symbol.Parameter{Name: strconv.Itoa(len(currSymbol.Parameters)), DefaultValue: patternValue}
